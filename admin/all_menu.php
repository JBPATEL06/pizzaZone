...
<head>
 ...
 <script>
    function con_msg()
    {
        var msg=confirm("Are You sure you want to delete menu");
        if(msg==true)
        {
            return true;
        }
                                                                            ...
                                                                            $fetch=mysqli_fetch_array($newquery);
																					...
																					<td data-label="Product Price">₹'.$rows['price'].'</td>
																								...
																								<center><img src="images/'.$rows['image'].'" class="img-responsive  radius" style="max-height:150px;max-width:150px;" /></center>
																									 ...
																									 <td><a href="all_menu.php?id='.$rows['id'].'" onclick="return con_msg()"class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash" style="font-size:16px"></i></a> 
																									 <a href="update_menu.php?edit='.$rows['id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
