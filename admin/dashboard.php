    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="../uploads/<?php echo get_setting('logo', 'logo.png'); ?>" alt="homepage"
                                class="dark-logo" style="max-height:40px;" /></span>
                    </a>
                </div>
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><img src="../uploads/usericn.png" alt="user"
                                class="profile-pic" /></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-file-text"></i><span
                        ...
                        <li> <a href="manage_slider.php"><i class="fa fa-image"></i><span>Homepage Slider</span></a>
                        </li>
                        <li> <a href="settings.php#contact-info"><i class="fa fa-phone"></i><span>Contact
                                    Info</span></a></li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                            ...
                            <div class="col-md-4">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php
                                            $result = mysqli_query($conn, 'SELECT SUM(total_price) AS value_sum FROM orders WHERE status = "closed"');
                ...
                <footer class="footer"> © Copyright @ 2026 FlowerZone by Srushti Lakkad | All Rights Reserved! </footer>
