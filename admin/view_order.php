                            ...
                            <div class="card-header">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											 $sql="SELECT * FROM orders where id='$_GET[user_upd]'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['name']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('update_order.php?form_id=<?php echo htmlentities($rows['id']);?>');" title="Update order">
											...
											<tr>
												<td><strong>number:</strong></td>
												    <td><center><?php echo $rows['number']; ?></center></td>
													    <td><center>
													   </center></td>
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['total_products']; ?></center></td>
													  
												   																							
											</tr>
											<tr>
													<td><strong>Price:</strong></td>
												    <td><center>$<?php echo $rows['total_price']; ?></center></td>
													   
												   																							
											</tr>
											<tr>
													<td><strong>Address:</strong></td>
												    <td><center><?php echo $rows['street']; ?></center></td>
